...
""").split("\n")
    target = input(Fore.RED + "Enter Your address target" + Fore.YELLOW + " ==>  ").text
    if target == "" or None:
        try:
            print(Fore.RED + "Ok Good Lunch" + Fore.YELLOW + " ;)")
            time.sleep(2)
            sys.exit()
        except:
            pass
    ...
    for i in my_list:
        ...
        if q.status_code == 200:
            print(Fore.BLUE  + "[+] " + Fore.GREEN + q + Fore.YELLOW + " | " + Fore.BLUE + " > Found")
        else:
            print(Fore.BLUE + "[-] " + Fore.RED+  q + Fore.YELLOW + " | "  + Fore.BLUE+" > Not Found " )
    try:
        print(Fore.YELLOW + "Pleass Enter A Latter")
        input("")
        sys.exit()
    except:
        pass
